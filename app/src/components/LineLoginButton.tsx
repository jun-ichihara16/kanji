...
export default function LineLoginButton({ className = '' }: { className?: string }) {
  return (
    <button
      ...
      className={`w-full flex items-center justify-center gap-2.5 bg-line text-white font-bold py-4 rounded-xl hover:brightness-95 hover:-translate-y-0.5 transition-all ${className}`}
    >
